...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11-Jun-2021 às 05:56
...
(1, 'https://localhost/', 'https://localhost/', 'https://localhost/');
...
('1', 'Sua Empresa', 'suaempres@gmail.com', 'São Paulo', '01852376598', 'https://www.dominio.com/', 1);
...
(16, 'accounts_summary', 'Accounts Summary', NULL, 'Resumo de contas'),
...
(33, 'supplier_payment_actual', 'Supplier Payment Ledger', NULL, 'Livro razão de pagamentos de fornecedores'),
...
(53, 'online', 'Online', NULL, 'Online'),
(54, 'logout', 'Logout', NULL, 'Sair'),
(55, 'change_password', 'Change Password', NULL, 'Alterar a senha'),
...
(97, 'inactive', 'Inactive', NULL, 'Inativa'),
...
(109, 'qr_code', 'Qr-Code', NULL, 'Código QR'),
...
(123, 'in', 'In', NULL, 'Dentro'),
(124, 'to', 'To', NULL, 'Para'),
(125, 'previous_balance', 'Previous Credit Balance', NULL, 'Saldo de crédito anterior'),
...
(131, 'mobile', 'Mobile', NULL, 'Móvel'),
(132, 'address', 'Address', NULL, 'Endereço'),
(133, 'manage_your_customer', 'Manage your customer', NULL, 'Manage your customer'),
...
(136, 'ammount', 'Amount', NULL, 'Resultar'),
...
(158, 'discount', 'Dis./Pcs.', NULL, 'Desconto/Pcs'),
...
(164, 'add_new_pos_invoice', 'Add new pos Sale', NULL, 'Adicionar nova venda de pos'),
...
(172, 'website', 'Website', NULL, 'Website'),
(173, 'email', 'Email', NULL, 'E-mail'),
...
(195, 'account_summary_report', 'Account Summary Report', NULL, 'Relatório de resumo da conta'),
...
(202, 'cash_in', 'Cash In', NULL, 'Dinheiro em'),
...
(207, 'account_closing_report', 'Account Closing Report', NULL, 'Relatório de fechamento de conta'),
(208, 'last_day_ammount', 'Last Day Amount', NULL, 'Quantidade do último dia'),
...
(213, 'accounts_summary_report', 'Accounts Summary Report', NULL, 'Relatório de resumo de contas'),
...
(222, 'company_name', 'Niha International', NULL, 'Nome da Empresa'),
...
(228, 'last_name', 'Last Name', NULL, 'Sobrenome'),
...
(251, 'old_information', 'Old Information', NULL, 'Informação Antiga'),
...
(269, 'successfully_delete', 'Successfully Delete.', NULL, 'Excluir com sucesso.'),
...
(278, 'manage_your_supplier', 'Manage your supplier', NULL, 'Gerenciar seu fornecedor'),
...
(282, 'supplier_actual_ledger', 'Supplier Payment Ledger', NULL, 'Livro razão de pagamentos de fornecedores'),
...
(317, 'thank_you_for_choosing_us', 'Thank you very much for choosing us.', NULL, 'Obrigado por nos escolher'),
...
(321, 'you_cant_delete_this_product', 'Sorry !!  You can\'t delete this product.This product already used in calculation system!', NULL, 'Desculpe !! Você não pode excluir este produto. Este produto já é usado no sistema de cálculo!'),
...
(330, 'account_edit', 'Account Edit', NULL, 'Edição de conta'),
...
(342, 'available_qnty', 'Av. Qnty.', NULL, 'Av. Qnty.'),
...
(350, 'total_cartoon', 'Total Cartoon', NULL, 'Total Cartoon'),
...
(354, 'if_you_update_purchase_first_select_supplier_then_product_and_then_quantity', 'If you update purchase,first select supplier then product and then update qnty.', NULL, 'Se você atualizar a compra, primeiro selecione o fornecedor, depois o produto e, a seguir, atualize o qnty.'),
...
(362, 'hostname', 'Host name', NULL, 'Nome de anfitrião'),
...
(390, 'in_qnty', 'In Qnty.', NULL, 'Em Quant.'),
(391, 'out_qnty', 'Out Qnty.', NULL, 'Out Qnty.'),
...
(398, 'in_quantity', 'In Qnty.', NULL, 'Em Quant.'),
(399, 'out_quantity', 'Out Qnty.', NULL, 'Out Quantidade'),
(400, 'in_taka', 'In TK.', NULL, 'Em TK'),
(401, 'out_taka', 'Out TK.', NULL, 'Out TK.'),
...
(413, 'branch', 'Branch', NULL, 'Galho'),
(414, 'ac_no', 'A/C Number', NULL, 'Número A/C'),
(415, 'ac_name', 'A/C Name', NULL, 'Nome A/C'),
...
(440, 'person_ledger', 'Person Ledger', NULL, 'Livro Razão de Pessoa'),
...
(451, 'backup_and_restore', 'Backup', NULL, 'Backup'),
(452, 'backup_successfully', 'Backup successfully', NULL, 'Backup com sucesso'),
(453, 'delete_successfully', 'Delete successfully', NULL, 'Apagar com sucesso'),
...
(458, 'kilogram_kg', 'Kilogram (Kg)', NULL, 'Quilograma (Kg)'),
(459, 'stock_cartoon', 'Stock Cartoon', NULL, 'Stock Cartoon'),
...
(468, 'full_paid', 'Full Paid', NULL, 'Pagamento Completo'),
...
(487, 'you_can_not_buy_greater_than_available_qnty', 'You can not buy greater than available qnty.', NULL, 'Você não pode comprar mais do que qnty disponível.'),
...
(505, 'discount_percentage', 'Discount', NULL, 'Porcentagem de desconto'),
(506, 'fixed_dis', 'Fixed Dis.', NULL, 'Des. Fixo'),
(507, 'return', 'Return', NULL, 'Devoluções'),
...
(510, 'return_invoice', 'Sale Return', NULL, 'Retorno de venda'),
(511, 'sold_qty', 'Sold Qty', NULL, 'Qtd vendida'),
(512, 'ret_quantity', 'Return Qty', NULL, 'Retorno Qtd'),
...
(568, 'accounts_tree_view', 'Accounts Tree View', NULL, 'Visão em árvore das contas'),
(569, 'debit_voucher', 'Debit Voucher', NULL, 'Voucher de Débito'),
(570, 'voucher_no', 'Voucher No', NULL, 'Voucher nº'),
...
(574, 'amount', 'Amount', NULL, 'Resultar'),
(575, 'approved', 'Approved', NULL, 'Aprovado'),
(576, 'debit_account_head', 'Debit Account Head', NULL, 'Chefe da conta de débito'),
(577, 'credit_voucher', 'Credit Voucher', NULL, 'Voucher de crédito'),
(578, 'find', 'Find', NULL, 'Achar'),
(579, 'transaction_date', 'Transaction Date', NULL, 'Data de Transação'),
(580, 'voucher_type', 'Voucher Type', NULL, 'Tipo de voucher'),
(581, 'particulars', 'Particulars', NULL, 'Particulars'),
...
(588, 'from_date', 'From Date', NULL, 'A partir da data'),
...
(599, 'coa_print', 'Coa Print', NULL, 'Coa Print'),
...
(605, 'contra_voucher', 'Contra Voucher', NULL, 'Contra Voucher'),
(606, 'voucher_approval', 'Vouchar Approval', NULL, 'Aprovação de voucher'),
...
(610, 'account_code', 'Account Head', NULL, 'Chefe da conta'),
...
(616, 'forgot_password', 'Forgot Password ??', NULL, 'Esqueceu a senha ??'),
...
(627, 'currency_name', 'Currency Name', NULL, 'Nome da Moeda'),
...
(634, 'add_role', 'Add Role', NULL, 'Adicionar Função'),
...
(643, 'role_name', 'Role Name', NULL, 'Nome da Função'),
(644, 'qty', 'Quantity', NULL, 'Quantidade'),
...
(659, 'item_description', 'Desc', NULL, 'Desc'),
...
(673, 'employee', 'Employee', NULL, 'Empregado'),
...
(682, 'employee_type', 'Employee Type', NULL, 'Tipo de Funcionário'),
(683, 'employee_designation', 'Employee Designation', NULL, 'Designação de Funcionário'),
...
(699, 'employee_update', 'Employee Update', NULL, 'Atualização de funcionário'),
(700, 'checkin', 'Check In', NULL, 'Verificação de Entrada'),
(701, 'employee_name', 'Employee Name', NULL, 'Nome do empregado'),
...
(708, 'bulk_checkin', 'Bulk Check In', NULL, 'Volume Check In'),
...
(711, 'datewise_report', 'Date Wise Report', NULL, 'Relatório Data Wise'),
(712, 'employee_wise_report', 'Employee Wise Report', NULL, 'Relatório de Funcionário Wise'),
(713, 'date_in_time_report', 'Date In Time Report', NULL, 'Relatório de data no tempo'),
(714, 'request', 'Request', NULL, 'Solicitação'),
...
(747, 'employee_salary_payment', 'Employee Salary Payment', NULL, 'Pagamento de Salário de Funcionário'),
...
(753, 'confirm', 'Confirm', NULL, 'Confirmar'),
...
(771, 'gui_pos', 'GUI POS', NULL, 'GUI POS'),
...
(781, 'hanging_over', 'ETD', NULL, 'ETD'),
(782, 'service_details', 'Service Details', NULL, 'Detalhes do serviço'),
(783, 'tax_settings', 'Tax Settings', NULL, 'Configurações de impostos'),
...
(791, 'invoice_wise_tax_report', 'Invoice Wise Tax Report', NULL, 'Fatura Wise Tax Report'),
...
(836, 'change', 'Change', NULL, 'Alterar'),
...
(853, 'quotation_no', 'Quotation No', NULL, 'Cotação Não'),
...
(858, 'service_total', 'Service Total', NULL, 'Total de serviço'),
...
(901, 'note', 'Note', NULL, 'Observação'),
(902, 'update_debit_voucher', 'Update Debit Voucher', NULL, 'Atualizar comprovante de débito'),
(903, 'update_credit_voucher', 'Update Credit voucher', NULL, 'Atualizar voucher de crédito'),
(904, 'on', 'On', NULL, 'Sobre'),
(905, '', '', NULL, ''),
...
(910, 'employee_signature', 'Employee Signature', NULL, 'Assinatura do empregado'),
(911, 'payslip', 'Payslip', NULL, 'Payslip'),
(912, 'exsisting_role', 'Existing Role', NULL, 'Papel Existente'),
(913, 'filter', 'Filter', NULL, 'Filtro'),
(914, 'testinput', NULL, NULL, 'Entrada de texto'),
...
(918, 'expiry', 'Expiry', NULL, 'Expiração');
...
(2, '1', 'User', 'Admin', NULL, NULL, NULL, NULL, NULL, 'http://bigook.com/assets/dist/img/profile_picture/profile.jpg', 1);
...
(2, '1', 'admin@admin.com', 'd195eb7a245a7f60f6387430aa6e8bef', 1, NULL, 1);
...
(1, 'https://localhost/bg-erp/./my-assets/image/logo/7ddf43e10d6820c87476876aa08d746d.png', 'https://localhost/bg-erp/./my-assets/image/logo/2e655f0788291a0421dc44cbcc00beb7.png', 'https://localhost/bg-erp/my-assets/image/logo/348b8bfb16c560be2f76a0e65dfd9e30.png', 'R$', 'Europe/Bratislava', '0', '© 2021 Bigook.com All rights reserved.', 'portugues', '0', 1, '6LdiKhsUAAAAAMV4jQRmNYdZy2kXEuFe1HrdP5tt', '6LdiKhsUAAAAAMV4jQRmNYdZy2kXEuFe1HrdP5tt', 1);
